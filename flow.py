...
class Flow:
    ...
    def source_bytes(self, s_bytes):
        self.src_bytes += s_bytes

    def total_bytes(self, t_bytes):
        self.tot_bytes += t_bytes
    ...
    def print_flow(self):
        return f"{self.start},{self.dur},{self.proto},{self.src},{self.dir},{self.dst},{self.tot_packets}," \
               f"{self.tot_bytes},{self.src_bytes},{self.label}\n"
